...
namespace EmployeePortal.Controllers
{
    public class EmailTemplatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Active,Type,TextData")] EmailTemplate emailTemplate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Active,Type,TextData")] EmailTemplate emailTemplate)
        {
            if (ModelState.IsValid)
            {
